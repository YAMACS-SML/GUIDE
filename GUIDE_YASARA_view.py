...
# TOPIC:       SML
# TITLE:       SML
# AUTHOR:      A.sarkar # VERSION 3.7 edited
...
###charge of the reactant molecule
  ...
  smidata=smi.read()
  mol=Chem.MolFromSmiles(smidata)
...
##counting the object present in the yasara window
  ...
  #  k.write(str(processor))
   # k.write('\nend')
    ...
    if mod == str(1): 
      print('check')
      os.system(orca+' '+macrotarget+'/'+' QM_reactant.inp >' +macrotarget+'/'+'QM_reactant.out')
    elif mod == str(2):
      nameobj='QM_reactant'
